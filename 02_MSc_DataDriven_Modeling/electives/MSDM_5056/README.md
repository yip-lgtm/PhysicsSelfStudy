# MSDM — Network Science
> **HKUST MSDM_5056 | intermediate, requires prior physics + calculus**  
...
1. 為什麼呢個領域嘅 Graph theory 概念 fundamental?

2. 解釋 Centrality 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Dynamics 在呢度重要?

5. 解釋 Graph theory 嘅 limitations。
...
## 深入 1：Foundations: Graph theory
**Deep Dive I**

### Bilingual concept table for foundations: graph theory
...
```mermaid
graph TD
    A[Input: foundations: graph theory] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Graph theory for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Centrality fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply Graph theory to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Dynamics.
**Self-Test 6**
...
## 自測 10：Design measurement for Graph theory.
**Self-Test 10**
...
## 📊 Diagram 1: Network Science Concept Map 1
```mermaid
graph TD
    A[Network Science] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Network Science Concept Map 2
```mermaid
graph TD
    A[Network Science] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Network Science Concept Map 3
```mermaid
graph TD
    A[Network Science] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Network Science Concept Map 4
```mermaid
graph TD
    A[Network Science] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Network Science Concept Map 5
```mermaid
graph TD
    A[Network Science] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
