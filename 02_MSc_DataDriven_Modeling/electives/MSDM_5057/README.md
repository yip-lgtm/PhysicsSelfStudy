# MSDM — Business Literacy
> **HKUST MSDM_5057 | introductory level, no prerequisites beyond high-school physics**  
...
1. 為什麼呢個領域嘅 Finance 概念 fundamental?

2. 解釋 Marketing 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Strategy 在呢度重要?

5. 解釋 Finance 嘅 limitations。
...
## 深入 1：Foundations: Finance
**Deep Dive I**

### Bilingual concept table for foundations: finance
...
```mermaid
graph TD
    A[Input: foundations: finance] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Finance for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Marketing fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply Finance to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Strategy.
**Self-Test 6**
...
## 自測 10：Design measurement for Finance.
**Self-Test 10**
...
## 📊 Diagram 1: Business Literacy Concept Map 1
```mermaid
graph TD
    A[Business Literacy] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Business Literacy Concept Map 2
```mermaid
graph TD
    A[Business Literacy] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Business Literacy Concept Map 3
```mermaid
graph TD
    A[Business Literacy] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Business Literacy Concept Map 4
```mermaid
graph TD
    A[Business Literacy] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Business Literacy Concept Map 5
```mermaid
graph TD
    A[Business Literacy] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
