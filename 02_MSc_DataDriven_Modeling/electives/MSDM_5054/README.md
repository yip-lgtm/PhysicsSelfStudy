# MSDM — Statistical Machine Learning
> **HKUST MSDM_5054 | intermediate, requires prior physics + calculus**  
...
3. **Data-driven models complement theory** — 數據驅動模型補充理論 (PINN, surrogate)
...
1. 為什麼呢個領域嘅 Regression 概念 fundamental?

2. 解釋 Classification 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Regularization 在呢度重要?

5. 解釋 Regression 嘅 limitations。
...
## 深入 1：Foundations: Regression
**Deep Dive I**

### Bilingual concept table for foundations: regression
...
```mermaid
graph TD
    A[Input: foundations: regression] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Regression for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Classification fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply Regression to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Regularization.
**Self-Test 6**
...
## 自測 8：Connect to Classification.
**Self-Test 8**
...
## 自測 10：Design measurement for Regression.
**Self-Test 10**
...
## 📊 Diagram 1: Statistical Machine Learning Concept Map 1
```mermaid
graph TD
    A[Statistical Machine Learning] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Statistical Machine Learning Concept Map 2
```mermaid
graph TD
    A[Statistical Machine Learning] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Statistical Machine Learning Concept Map 3
```mermaid
graph TD
    A[Statistical Machine Learning] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Statistical Machine Learning Concept Map 4
```mermaid
graph TD
    A[Statistical Machine Learning] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Statistical Machine Learning Concept Map 5
```mermaid
graph TD
    A[Statistical Machine Learning] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
