# MSDM — Seminars
> **HKUST MSDM_6771 | intermediate, requires prior physics + calculus**  
...
## 📊 Diagram 1: Seminars Concept Map 1
```mermaid
graph TD
    A[Seminars] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Seminars Concept Map 2
```mermaid
graph TD
    A[Seminars] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Seminars Concept Map 3
```mermaid
graph TD
    A[Seminars] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Seminars Concept Map 4
```mermaid
graph TD
    A[Seminars] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Seminars Concept Map 5
```mermaid
graph TD
    A[Seminars] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
