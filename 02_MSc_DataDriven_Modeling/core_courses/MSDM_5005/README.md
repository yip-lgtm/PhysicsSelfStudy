# MSDM — Innovation in Practice
> **HKUST MSDM_5005 | intermediate, requires prior physics + calculus**  
...
1. 為什麼呢個領域嘅 Entrepreneurship 概念 fundamental?
...
5. 解釋 Entrepreneurship 嘅 limitations。
...
## 深入 1：Foundations: Entrepreneurship
**Deep Dive I**

### Bilingual concept table for foundations: entrepreneurship
...
```mermaid
graph TD
    A[Input: foundations: entrepreneurship] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Entrepreneurship for typical case.
**Self-Test 1**
...
## 自測 3：Apply Entrepreneurship to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of IP.
**Self-Test 6**
...
## 自測 10：Design measurement for Entrepreneurship.
**Self-Test 10**
...
## 📊 Diagram 1: Innovation in Practice Concept Map 1
```mermaid
graph TD
    A[Innovation in Practice] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Innovation in Practice Concept Map 2
```mermaid
graph TD
    A[Innovation in Practice] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Innovation in Practice Concept Map 3
```mermaid
graph TD
    A[Innovation in Practice] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Innovation in Practice Concept Map 4
```mermaid
graph TD
    A[Innovation in Practice] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Innovation in Practice Concept Map 5
```mermaid
graph TD
    A[Innovation in Practice] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
