# MSDM — Numerical Methods
> **HKUST MSDM_5004_Numerical_Methods | intermediate, requires prior physics + calculus**  
...
1. 為什麼呢個領域嘅 ODE/PDE 概念 fundamental?

2. 解釋 Optimization 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Linear algebra 在呢度重要?

5. 解釋 ODE/PDE 嘅 limitations。
...
## 深入 1：Foundations: ODE/PDE
**Deep Dive I**

### Bilingual concept table for foundations: ode/pde
...
```mermaid
graph TD
    A[Input: foundations: ode/pde] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive ODE/PDE for typical case.
**Self-Test 1**
...
## 自測 3：Apply ODE/PDE to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Linear algebra.
**Self-Test 6**
...
## 自測 10：Design measurement for ODE/PDE.
**Self-Test 10**
...
## 📊 Diagram 1: Numerical Methods Concept Map 1
```mermaid
graph TD
    A[Numerical Methods] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Numerical Methods Concept Map 2
```mermaid
graph TD
    A[Numerical Methods] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Numerical Methods Concept Map 3
```mermaid
graph TD
    A[Numerical Methods] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Numerical Methods Concept Map 4
```mermaid
graph TD
    A[Numerical Methods] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Numerical Methods Concept Map 5
```mermaid
graph TD
    A[Numerical Methods] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
