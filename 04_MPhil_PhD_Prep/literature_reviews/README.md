...
> **Phase 4 | Key papers by topic for PhD prep**
...
- Key papers: Shor, Grover, quantum error correction

### Machine Learning for Physics
- Raissi et al. — Physics-informed neural networks
- Carleo et al. — Neural network quantum states
- Karniadakis et al. — Physics-informed ML survey

### Quantum Computing
- IBM Qiskit Textbook
- Google's quantum supremacy paper (2019)

### Condensed Matter
- Anderson — More is Different
- Topological insulators (Hasan & Kane 2010)
- High-Tc superconductivity reviews

### Materials Science
- DFT reviews
- Machine learning for materials (Lookman et al.)

### Nano Science
- Drexler — Nanosystems
- Nanomaterials synthesis (recent reviews)
