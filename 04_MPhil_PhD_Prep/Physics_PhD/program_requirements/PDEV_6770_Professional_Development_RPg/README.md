# PDEV — Professional Development for RPg
> **HKUST PDEV_6770_Professional_Development_RPg | introductory level, no prerequisites beyond high-school physics**  
...
1. 為什麼呢個領域嘅 Career 概念 fundamental?

2. 解釋 Skills 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Networking 在呢度重要?

5. 解釋 Career 嘅 limitations。
...
## 深入 1：Foundations: Career
**Deep Dive I**

### Bilingual concept table for foundations: career
...
```mermaid
graph TD
    A[Input: foundations: career] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Career for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Skills fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply Career to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Networking.
**Self-Test 6**
...
## 自測 10：Design measurement for Career.
**Self-Test 10**
...
## 📊 Diagram 1: Professional Development for RPg Concept Map 1
```mermaid
graph TD
    A[Professional Development for RPg] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Professional Development for RPg Concept Map 2
```mermaid
graph TD
    A[Professional Development for RPg] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Professional Development for RPg Concept Map 3
```mermaid
graph TD
    A[Professional Development for RPg] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Professional Development for RPg Concept Map 4
```mermaid
graph TD
    A[Professional Development for RPg] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Professional Development for RPg Concept Map 5
```mermaid
graph TD
    A[Professional Development for RPg] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
