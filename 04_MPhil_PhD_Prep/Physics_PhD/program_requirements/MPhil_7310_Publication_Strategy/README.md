...
```mermaid
graph TD
    A[Manuscript ready] --> B{Audience}
    B -->|Broad physics| C[PRL, Nature Physics]
    B -->|Subfield| D[PRX, PR Applied]
    B -->|Materials| E[J. Materials Chem A]
    B -->|Applied energy| F[Joule, EES]
    C --> G[Check length]
    D --> H[Submit]
    E --> H
    F --> H
...
gantt
    ...
    arXiv preprint :2025-01, 14d
    section Review
    Journal submission :2025-01, 7d
    Review period :2025-02, 60d
    revision :2025-04, 30d
    section Post-acceptance
    Publication :2025-05, 7d
    Post-publication :2025-05, 365d
```
