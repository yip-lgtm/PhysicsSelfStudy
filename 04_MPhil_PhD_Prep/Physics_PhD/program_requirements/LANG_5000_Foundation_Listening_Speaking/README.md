# LANG — Foundation Listening and Speaking
> **HKUST LANG_5000_Foundation_Listening_Speaking | introductory level, no prerequisites beyond high-school physics**  
...
1. 為什麼呢個領域嘅 English 概念 fundamental?

2. 解釋 Communication 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Academic 在呢度重要?

5. 解釋 English 嘅 limitations。
...
## 深入 1：Foundations: English
**Deep Dive I**

### Bilingual concept table for foundations: english
...
```mermaid
graph TD
    A[Input: foundations: english] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive English for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Communication fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply English to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Academic.
**Self-Test 6**
...
## 自測 10：Design measurement for English.
**Self-Test 10**
...
## 📊 Diagram 1: Foundation Listening and Speaking Concept Map 1
```mermaid
graph TD
    A[Foundation Listening and Speaking] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Foundation Listening and Speaking Concept Map 2
```mermaid
graph TD
    A[Foundation Listening and Speaking] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Foundation Listening and Speaking Concept Map 3
```mermaid
graph TD
    A[Foundation Listening and Speaking] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Foundation Listening and Speaking Concept Map 4
```mermaid
graph TD
    A[Foundation Listening and Speaking] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Foundation Listening and Speaking Concept Map 5
```mermaid
graph TD
    A[Foundation Listening and Speaking] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
