# MSPY — Computational Simulation Tools
> **HKUST MSPY_5230_Computational_Simulation_Tools | advanced, requires full undergrad physics + math maturity**  
...
### Bilingual concept table for foundations: md
...
```mermaid
graph TD
    A[Input: foundations: md] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive MD for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 DFT fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply MD to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of FEA.
**Self-Test 6**
...
## 自測 10：Design measurement for MD.
**Self-Test 10**
...
## 📊 Diagram 1: Computational Simulation Tools Concept Map 1
```mermaid
graph TD
    A[Computational Simulation Tools] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Computational Simulation Tools Concept Map 2
```mermaid
graph TD
    A[Computational Simulation Tools] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Computational Simulation Tools Concept Map 3
```mermaid
graph TD
    A[Computational Simulation Tools] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Computational Simulation Tools Concept Map 4
```mermaid
graph TD
    A[Computational Simulation Tools] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Computational Simulation Tools Concept Map 5
```mermaid
graph TD
    A[Computational Simulation Tools] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
