# MSPY — Computational Methods in Science
> **HKUST MSPY_5240_Computational_Methods_Science | advanced, requires full undergrad physics + math maturity**  
...
1. 為什麼呢個領域嘅 PDE solvers 概念 fundamental?

2. 解釋 Monte Carlo 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 High-perf 在呢度重要?

5. 解釋 PDE solvers 嘅 limitations。
...
## 深入 1：Foundations: PDE solvers
**Deep Dive I**

### Bilingual concept table for foundations: pde solvers
...
```mermaid
graph TD
    A[Input: foundations: pde solvers] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive PDE solvers for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Monte Carlo fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply PDE solvers to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of High-perf.
**Self-Test 6**
...
## 自測 10：Design measurement for PDE solvers.
**Self-Test 10**
...
## 📊 Diagram 1: Computational Methods in Science Concept Map 1
```mermaid
graph TD
    A[Computational Methods in Science] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Computational Methods in Science Concept Map 2
```mermaid
graph TD
    A[Computational Methods in Science] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Computational Methods in Science Concept Map 3
```mermaid
graph TD
    A[Computational Methods in Science] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Computational Methods in Science Concept Map 4
```mermaid
graph TD
    A[Computational Methods in Science] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Computational Methods in Science Concept Map 5
```mermaid
graph TD
    A[Computational Methods in Science] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
