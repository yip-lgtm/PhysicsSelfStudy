# MSPY — AI in Science
> **HKUST MSPY_5250_AI_in_Science | advanced, requires full undergrad physics + math maturity**  
...
1. 為什麼呢個領域嘅 ML for physics 概念 fundamental?

2. 解釋 Discovery 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Simulation 在呢度重要?

5. 解釋 ML for physics 嘅 limitations。
...
## 深入 1：Foundations: ML for physics
**Deep Dive I**

### Bilingual concept table for foundations: ml for physics
...
```mermaid
graph TD
    A[Input: foundations: ml for physics] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive ML for physics for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Discovery fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply ML for physics to a real problem.
**Self-Test 3**
...
## 自測 10：Design measurement for ML for physics.
**Self-Test 10**
...
## 📊 Diagram 1: AI in Science Concept Map 1
```mermaid
graph TD
    A[AI in Science] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: AI in Science Concept Map 2
```mermaid
graph TD
    A[AI in Science] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: AI in Science Concept Map 3
```mermaid
graph TD
    A[AI in Science] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: AI in Science Concept Map 4
```mermaid
graph TD
    A[AI in Science] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: AI in Science Concept Map 5
```mermaid
graph TD
    A[AI in Science] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
