# MSPY — Quantum Materials and Devices
> **HKUST MSPY_5002_Quantum_Materials_Devices | advanced, requires full undergrad physics + math maturity**  
...
2. **Quantum: measurement collapses state** — 量子: 量度導致塌縮 (Born rule)
...
1. 為什麼呢個領域嘅 Topological 概念 fundamental?

2. 解釋 Superconducting 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Quantum dots 在呢度重要?

5. 解釋 Topological 嘅 limitations。
...
## 深入 1：Foundations: Topological
**Deep Dive I**

### Bilingual concept table for foundations: topological
...
```mermaid
graph TD
    A[Input: foundations: topological] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Topological for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Superconducting fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply Topological to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Quantum dots.
**Self-Test 6**
...
## 自測 8：Connect to Superconducting.
**Self-Test 8**
...
## 自測 10：Design measurement for Topological.
**Self-Test 10**
...
## 📊 Diagram 1: Quantum Materials and Devices Concept Map 1
```mermaid
graph TD
    A[Quantum Materials and Devices] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Quantum Materials and Devices Concept Map 2
```mermaid
graph TD
    A[Quantum Materials and Devices] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Quantum Materials and Devices Concept Map 3
```mermaid
graph TD
    A[Quantum Materials and Devices] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Quantum Materials and Devices Concept Map 4
```mermaid
graph TD
    A[Quantum Materials and Devices] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Quantum Materials and Devices Concept Map 5
```mermaid
graph TD
    A[Quantum Materials and Devices] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
