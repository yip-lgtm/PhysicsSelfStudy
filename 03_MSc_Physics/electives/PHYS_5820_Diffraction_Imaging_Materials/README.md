# PHYS — Diffraction and Imaging of Materials
> **HKUST PHYS_5820_Diffraction_Imaging_Materials | advanced, requires full undergrad physics + math maturity**  
...
## 自測 2：為什麼 TEM fundamental to field?
**Self-Test 2**
...
## 📊 Diagram 1: Diffraction and Imaging of Materials Concept Map 1
```mermaid
graph TD
    A[Diffraction and Imaging of Materials] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Diffraction and Imaging of Materials Concept Map 2
```mermaid
graph TD
    A[Diffraction and Imaging of Materials] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Diffraction and Imaging of Materials Concept Map 3
```mermaid
graph TD
    A[Diffraction and Imaging of Materials] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Diffraction and Imaging of Materials Concept Map 4
```mermaid
graph TD
    A[Diffraction and Imaging of Materials] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Diffraction and Imaging of Materials Concept Map 5
```mermaid
graph TD
    A[Diffraction and Imaging of Materials] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
