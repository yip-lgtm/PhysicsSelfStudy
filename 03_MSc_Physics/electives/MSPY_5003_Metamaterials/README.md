# MSPY — Metamaterials
> **HKUST MSPY_5003_Metamaterials | advanced, requires full undergrad physics + math maturity**  
...
1. 為什麼呢個領域嘅 Sub-wavelength 概念 fundamental?

2. 解釋 Negative index 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Cloaking 在呢度重要?

5. 解釋 Sub-wavelength 嘅 limitations。
...
## 深入 1：Foundations: Sub-wavelength
**Deep Dive I**

### Bilingual concept table for foundations: sub-wavelength
...
```mermaid
graph TD
    A[Input: foundations: sub-wavelength] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Sub-wavelength for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Negative index fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply Sub-wavelength to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Cloaking.
**Self-Test 6**
...
## 自測 8：Connect to Negative index.
**Self-Test 8**
...
## 自測 10：Design measurement for Sub-wavelength.
**Self-Test 10**
...
## 📊 Diagram 1: Metamaterials Concept Map 1
```mermaid
graph TD
    A[Metamaterials] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Metamaterials Concept Map 2
```mermaid
graph TD
    A[Metamaterials] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Metamaterials Concept Map 3
```mermaid
graph TD
    A[Metamaterials] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Metamaterials Concept Map 4
```mermaid
graph TD
    A[Metamaterials] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Metamaterials Concept Map 5
```mermaid
graph TD
    A[Metamaterials] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
