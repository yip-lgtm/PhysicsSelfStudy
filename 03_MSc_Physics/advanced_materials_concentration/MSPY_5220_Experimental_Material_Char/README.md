# MSPY — Experimental Material Characterization
> **HKUST MSPY_5220_Experimental_Material_Char | advanced, requires full undergrad physics + math maturity**  
...
5. **Uncertainty quantification is fundamental** — 不確定度量化係根本 (statistical, systematic)
...
1. 為什麼呢個領域嘅 XRD 概念 fundamental?

2. 解釋 SEM/TEM 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Spectroscopy 在呢度重要?

5. 解釋 XRD 嘅 limitations。
...
## 深入 1：Foundations: XRD
**Deep Dive I**

### Bilingual concept table for foundations: xrd
...
```mermaid
graph TD
    A[Input: foundations: xrd] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive XRD for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 SEM/TEM fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply XRD to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Spectroscopy.
**Self-Test 6**
...
## 自測 10：Design measurement for XRD.
**Self-Test 10**
...
## 📊 Diagram 1: Experimental Material Characterization Concept Map 1
```mermaid
graph TD
    A[Experimental Material Characterization] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Experimental Material Characterization Concept Map 2
```mermaid
graph TD
    A[Experimental Material Characterization] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Experimental Material Characterization Concept Map 3
```mermaid
graph TD
    A[Experimental Material Characterization] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Experimental Material Characterization Concept Map 4
```mermaid
graph TD
    A[Experimental Material Characterization] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Experimental Material Characterization Concept Map 5
```mermaid
graph TD
    A[Experimental Material Characterization] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
