# MATH — Intro to Differential Equations
> **HKUST MATH_2351_Intro_Differential_Equations | intermediate, requires prior physics + calculus**  
...
1. 為什麼呢個領域嘅 ODEs 概念 fundamental?

2. 解釋 First-order 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Second-order 在呢度重要?

5. 解釋 ODEs 嘅 limitations。
...
## 深入 1：Foundations: ODEs
**Deep Dive I**

### Bilingual concept table for foundations: odes
...
```mermaid
graph TD
    A[Input: foundations: odes] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive ODEs for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 First-order fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply ODEs to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Second-order.
**Self-Test 6**
...
## 自測 10：Design measurement for ODEs.
**Self-Test 10**
...
## 📊 Diagram 1: Intro to Differential Equations Concept Map 1
```mermaid
graph TD
    A[Intro to Differential Equations] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Intro to Differential Equations Concept Map 2
```mermaid
graph TD
    A[Intro to Differential Equations] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Intro to Differential Equations Concept Map 3
```mermaid
graph TD
    A[Intro to Differential Equations] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Intro to Differential Equations Concept Map 4
```mermaid
graph TD
    A[Intro to Differential Equations] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Intro to Differential Equations Concept Map 5
```mermaid
graph TD
    A[Intro to Differential Equations] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
