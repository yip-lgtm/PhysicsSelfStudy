...
> **HKUST MATH_2352_Differential_Equations | intermediate, requires prior physics + calculus**  
...
1. 為什麼呢個領域嘅 Linear systems 概念 fundamental?
...
5. 解釋 Linear systems 嘅 limitations。
...
## 深入 1：Foundations: Linear systems
**Deep Dive I**

### Bilingual concept table for foundations: linear systems
...
```mermaid
graph TD
    A[Input: foundations: linear systems] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Linear systems for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Laplace fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply Linear systems to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Series.
**Self-Test 6**
...
## 自測 10：Design measurement for Linear systems.
**Self-Test 10**
...
## 📊 Diagram 1: Differential Equations Concept Map 1
```mermaid
graph TD
    A[Differential Equations] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Differential Equations Concept Map 2
```mermaid
graph TD
    A[Differential Equations] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Differential Equations Concept Map 3
```mermaid
graph TD
    A[Differential Equations] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Differential Equations Concept Map 4
```mermaid
graph TD
    A[Differential Equations] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Differential Equations Concept Map 5
```mermaid
graph TD
    A[Differential Equations] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
