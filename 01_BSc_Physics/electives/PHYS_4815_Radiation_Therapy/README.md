# PHYS — Radiation Therapy Physics
> **HKUST PHYS_4815_Radiation_Therapy | advanced, requires full undergrad physics + math maturity**  
...
1. 為什麼呢個領域嘅 Dosimetry 概念 fundamental?

2. 解釋 Treatment planning 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 Imaging 在呢度重要?

5. 解釋 Dosimetry 嘅 limitations。
...
## 深入 1：Foundations: Dosimetry
**Deep Dive I**

### Bilingual concept table for foundations: dosimetry
...
```mermaid
graph TD
    A[Input: foundations: dosimetry] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive Dosimetry for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Treatment planning fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply Dosimetry to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of Imaging.
**Self-Test 6**
...
## 自測 8：Connect to Treatment planning.
**Self-Test 8**
...
## 自測 10：Design measurement for Dosimetry.
**Self-Test 10**
...
## 📊 Diagram 1: Radiation Therapy Physics Concept Map 1
```mermaid
graph TD
    A[Radiation Therapy Physics] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Radiation Therapy Physics Concept Map 2
```mermaid
graph TD
    A[Radiation Therapy Physics] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Radiation Therapy Physics Concept Map 3
```mermaid
graph TD
    A[Radiation Therapy Physics] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Radiation Therapy Physics Concept Map 4
```mermaid
graph TD
    A[Radiation Therapy Physics] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Radiation Therapy Physics Concept Map 5
```mermaid
graph TD
    A[Radiation Therapy Physics] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
