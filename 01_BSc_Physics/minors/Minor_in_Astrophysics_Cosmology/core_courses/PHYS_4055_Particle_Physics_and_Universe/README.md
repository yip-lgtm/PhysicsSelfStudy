# PHYS — Particle Physics and Universe (cross-listed)
> **HKUST PHYS_4055_Particle_Physics_and_Universe_minor | advanced, requires full undergrad physics + math maturity**  
...
2. **Symmetry → conservation → standard model** — 對稱 → 守恆 → 標準模型
...
1. 為什麼呢個領域嘅 SM 概念 fundamental?

2. 解釋 Cosmology 嘅物理意義。

3. 給定一個典型問題, 點樣 apply 呢個領域嘅 核心方程?

4. 為什麼 BSM 在呢度重要?

5. 解釋 SM 嘅 limitations。
...
### Bilingual concept table for foundations: sm
...
```mermaid
graph TD
    A[Input: foundations: sm] --> B{Analysis}
    B --> C[Output]
```
...
## 自測 1：Derive SM for typical case.
**Self-Test 1**
...
## 自測 2：為什麼 Cosmology fundamental to field?
**Self-Test 2**
...
## 自測 3：Apply SM to a real problem.
**Self-Test 3**
...
## 自測 6：Identify limitations of BSM.
**Self-Test 6**
...
## 自測 10：Design measurement for SM.
**Self-Test 10**
...
## 📊 Diagram 1: Particle Physics and Universe (cross-listed) Concept Map 1
```mermaid
graph TD
    A[Particle Physics and Universe (cross-listed)] --> B{Subtopic 1}
    B --> C[Detail 1.1]
    B --> D[Detail 1.2]
```

## 📊 Diagram 2: Particle Physics and Universe (cross-listed) Concept Map 2
```mermaid
graph TD
    A[Particle Physics and Universe (cross-listed)] --> B{Subtopic 2}
    B --> C[Detail 2.1]
    B --> D[Detail 2.2]
```

## 📊 Diagram 3: Particle Physics and Universe (cross-listed) Concept Map 3
```mermaid
graph TD
    A[Particle Physics and Universe (cross-listed)] --> B{Subtopic 3}
    B --> C[Detail 3.1]
    B --> D[Detail 3.2]
```

## 📊 Diagram 4: Particle Physics and Universe (cross-listed) Concept Map 4
```mermaid
graph TD
    A[Particle Physics and Universe (cross-listed)] --> B{Subtopic 4}
    B --> C[Detail 4.1]
    B --> D[Detail 4.2]
```

## 📊 Diagram 5: Particle Physics and Universe (cross-listed) Concept Map 5
```mermaid
graph TD
    A[Particle Physics and Universe (cross-listed)] --> B{Subtopic 5}
    B --> C[Detail 5.1]
    B --> D[Detail 5.2]
```
