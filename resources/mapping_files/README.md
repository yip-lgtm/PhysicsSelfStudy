...
> **Alignment documents showing how self-study maps to HKUST degree requirements**

---

## 📂 Available Mapping Files

- `BSc_Physics_Mapping.md` — Self-study courses → HKUST BSc Physics requirements
- `MSc_DataDriven_Mapping.md` — Self-study courses → HKUST MSc Data-Driven Modeling
- `MSc_Physics_Mapping.md` — Self-study courses → HKUST MSc Physics (both concentrations)
- `PhD_Physics_Mapping.md` — Self-study prep → HKUST Physics PhD qualifying exam
- `PhD_NanoSci_Mapping.md` — Self-study prep → HKUST Nano Sci & Tech PhD
- `Minor_Physics_Mapping.md` — Self-study → Minor in Physics
- `Minor_Astro_Mapping.md` — Self-study → Minor in Astrophysics & Cosmology
